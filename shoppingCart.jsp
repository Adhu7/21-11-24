    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav ms-auto">
                ...
                <li class="nav-item">
                    <a class="nav-link active" href="shoppingCart.jsp">Shopping Cart</a>
                </li>
            </ul>
        </div>
    </div>
                        ...
                        <tbody>
                            <% for (CartBean item : cartItems) { %>
                                <tr>
                                    <td>
                                        <div class="d-flex">
                                            <img src="uploads/<%= item.getArtId() %>" alt="<%= item.getTitle() %>" class="product-img me-3">
                                            <div>
                                                <h5><%= item.getTitle() %></h5>
                                    ...
                                    <td>
                                        <a href="removeFromCartAction.jsp?cartId=<%= item.getCartId() %>" class="btn btn-danger btn-sm">Remove</a>
                                    </td>
                                </tr>
                            <% } %>
                        </tbody> 
